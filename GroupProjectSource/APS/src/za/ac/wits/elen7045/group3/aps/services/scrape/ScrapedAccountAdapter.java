...
public class ScrapedAccountAdapter {
	...
	public static CreditCardStatement getCreditCardAccount(AccountScrapedData scrapedAccount){
		CreditCardStatement creditAcc = new CreditCardStatement(scrapedAccount.getDataPairList().get(0).getValue());
	...
	public static MunicipalStatement getMunicipalAccount(AccountScrapedData scrapedAccount){
		MunicipalStatement municipalAcc = new MunicipalStatement(scrapedAccount.getDataPairList().get(0).getValue());
	...
	public static TelcoStatement getTelcoAccount(AccountScrapedData scrapedAccount){
		TelcoStatement telcoAcc = new TelcoStatement(scrapedAccount.getDataPairList().get(0).getValue());
